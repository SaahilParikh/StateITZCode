...
bool buttonHasBeenHeld6U = false;
bool isStackHeld = false;
bool buttonHasBeenHeld8D = false;
bool buttonHasBeenHeld7R = false;
...
int LIFT_AUTOSTACK_DOWN = LIFT_DOWN;
...
#define getLiftAv ((getLiftLeft+getLiftRight)/2)
